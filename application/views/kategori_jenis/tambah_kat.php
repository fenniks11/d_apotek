                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <form action="<?= base_url('kategori_dan_jenis/tambah_kategori') ?>" method="post">
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Nama Kategori <sup class="text-danger">*</sup></label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="nama_kategori" value="<?= set_value('nama_kategori') ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea rows="5" cols="5" class="form-control" name="des" value="<?= set_value('des') ?>"></textarea>
                                                <?= form_error('des') ?>
                                            </div>
                                        </div>
